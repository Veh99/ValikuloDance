...
{
    /// <inheritdoc />
    public partial class AddTelegramChatBindings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "TelegramChatBindings",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelegramChatBindings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TelegramChatBindings_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TelegramChatBindings_TelegramChatId",
                table: "TelegramChatBindings",
                column: "TelegramChatId",
                unique: true,
                filter: "\"IsDeleted\" = false");

            migrationBuilder.CreateIndex(
                name: "IX_TelegramChatBindings_UserId",
                table: "TelegramChatBindings",
                column: "UserId",
                unique: true,
                filter: "\"IsDeleted\" = false");
